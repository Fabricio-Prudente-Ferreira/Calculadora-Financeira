function calculo(){
    ...
    var valorManutencao = Number(input_manutencao.value) * 1000000;
    var valorFuncionario = Number(input_funcionario.value) * 1000000;
    var qtdCiclo = Number(input_qtdCiclo.value);
    var valorCiclo = Number(input_ciclo.value) * 1000000;
    var qtdMotor = Number(input_qtdMotor.value);

    //Variáveis default
    var custoInstall = 15000 * qtdMotor;
    var qtdFuncionario = valorFuncionario / 5000;
